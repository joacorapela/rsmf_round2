...
\href{https://nenckiopenlab.org/tbns2025/}{Transatlantic Behavioural
...
preserve of elite or technically specialised groups. With Bonsai.ML, we extend 
this philosophy by providing non-programmers with state-of-the-art ML tools.
...
and diverse experimental examples.
Our documentation approach will closely follow 
the \texttt{scikit-learn} project, which is internationally recognised for 
...
reduce financial and travel barriers.
